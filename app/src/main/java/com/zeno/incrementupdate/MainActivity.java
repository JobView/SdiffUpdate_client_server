...
//        String root = Environment.getExternalStorageDirectory().getAbsolutePath() + File.separator + "patch";

        new ApkUpdateTask().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR);
//        BspatchJNI.bspatchJNI(root + File.separator + "1.jpg", root + File.separator + "patch.jpg", root + File.separator + "patch");
    }
