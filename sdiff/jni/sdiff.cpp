...
#include "bzlib.h"
#include "jni.h"
#include "com_wzf_sdiff_SdiffHelper.h"
#include <stdio.h>
#include <string.h>
//#include <err.h>
//#include <unistd.h>
...
Java_com_wzf_sdiff_SdiffHelper_diff(JNIEnv *env, jclass jcls, jstring oldfile_jstr, jstring newfile_jstr, jstring patchfile_jstr) {
    int argc = 4;
